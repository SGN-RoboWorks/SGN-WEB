        ...
        <div className="min-h-screen bg-white text-[#1a1a1a] overflow-x-hidden">
            ...
            <section ref={heroRef} className="relative h-screen overflow-hidden">
                                ...
                                {navLinks.map((link) => (
                                    <a
                                        ...
                                        className={`text-[15px] md:text-[17px] tracking-wide transition-colors duration-300 ${isScrolled ? "text-black hover:text-gray-600" : "text-white hover:opacity-70"
                                            } drop-shadow-sm ${link === 'Home' ? 'flex' : 'hidden md:flex'}`}
                                    >
                                        {link}
                                    </a>
                                ))}
                ...
                <motion.div
                    ...
                    className="absolute z-20 flex flex-col items-center justify-center bottom-24 md:bottom-8 left-4 right-4 md:left-12 md:right-auto shadow-2xl mx-auto md:mx-0 rounded-[40px] md:rounded-[60px] rounded-bl-[4px] md:rounded-bl-[4px] p-8 md:p-12 w-[calc(100%-32px)] md:w-[320px] max-w-[320px]"
                    style={{
                ...
                >
                    ...
                    <div className="font-[Playfair_Display] text-white text-[70px] md:text-[130px] leading-[0.75] text-center tracking-tighter">
                        SGN
                    </div>

                    {/* RoboWorks Text - Switched to Serif-style look to match Image 1 */}
                    <div className="font-[Playfair_Display] text-white text-[22px] md:text-[34px] mt-2 mb-6 md:mb-8 text-center font-normal ">
                        RoboWorks
                    </div>
                    ...
                    <motion.a
                        ...
                        className="flex items-center justify-center border border-white text-white font-medium hover:bg-white hover:text-black hover:scale-105 transition-all shadow-md backdrop-blur-sm w-[140px] md:w-[160px] h-[40px] md:h-[44px] rounded-full text-[14px] md:text-[15px]"
                    >
                        Contact
                    </motion.a>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="absolute z-20 bottom-8 md:bottom-12 left-1/2 -translate-x-1/2"
                >
                    <a
                        href="#welcome"
                        className="explore-capsule shadow-sm hover:scale-105 transition-all flex items-center justify-center gap-2 md:gap-3 p-3 md:p-4 px-8 md:px-12"
                    >
                        <span className="text-[14px] md:text-[18px] font-normal tracking-wide text-white drop-shadow-sm">Explore</span>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-white drop-shadow-sm md:w-6 md:h-6">
            ...
            <section id="welcome" className="py-24 bg-white  relative" ref={welcomeRef}>
                <div className="max-w-11xl mx-auto px-4 md:px-8 text-center relative z-10 w-full">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        variants={fadeUp}
                        className="text-center max-w-[900px] mx-auto py-16 md:py-24 px-6"
                    >
                        <h2 className="font-[Playfair_Display] text-[42px] md:text-[84px] font-normal text-[#1a1a1a] mb-8 md:mb-12">
                            SGN Roboworks
                        </h2>
                        ...
                        <div>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="font-[Playfair_Display] text-base md:text-lg">Roboworks</p>
                                </div>
                            </div>
